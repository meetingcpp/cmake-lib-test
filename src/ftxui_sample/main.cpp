...
// configuration step. It creates a namespace called `cmake_lib_test`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cmake_lib_test::cmake::project_name, cmake_lib_test::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", cmake_lib_test::cmake::project_version);
      return EXIT_SUCCESS;
    }
